# Eventory: Blockchain-Powered Event Management Platform
...
- **Secure Transactions:** Leveraging the Arbitrum blockchain to ensure transparency and security for all ticket-related transactions.
...
- **Smart Contract Deployed on Arbitrum Sepolia:**  
  ...
  - **Explore on Arbiscan:** [View Contract on Arbiscan](https://sepolia.arbiscan.io/address/0x947CfA21d4afC66f1111D5a74865B8B9ba490C9E)
...
Follow these steps to set up and run the Eventory project locally:
...
-   Make sure your blockchain wallet is configured to interact with the Arbitrum Sepolia Testnet when testing blockchain functionalities.
